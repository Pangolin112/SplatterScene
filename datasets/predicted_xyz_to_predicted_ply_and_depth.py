...
# predicted_xyz = get_user_input('Enter the predicted_xyz index : ')
...
def visualize_depth(depths, projected_points, predicted_xyz, pred_img_idx, width=1280, height=1280, device='cuda'):
    ...
    output_image_path = file_path + str(predicted_xyz) + '_DSC00' + str(pred_img_idx) + '.jpg'
    cv2.imwrite(output_image_path, depth_image_np)
    return depth_image
for predicted_xyz in range(1000,1301, 100):
    files_path = '/home/qianru/Projects/TUM/TUM_2/ADL4CV/Data/ScanNetpp/data_1/0cf2e9402d/'
    ply_file_path = files_path + 'ply_predicted/'+str(predicted_xyz)+'.ply'
    txt_file_path = '/home/qianru/Projects/TUM/TUM_2/ADL4CV/Data/ScanNetpp/data_1/0cf2e9402d/xyz_predicted/predicted_xyz'+str(predicted_xyz)+'.txt'
    ...
    for pred_img_idx in range(350, 352):
        # File paths and data reading

        # depth_path = files_path + 'depth/DSC00'+str(predicted_xyz)+'.jpg'
        intrinsics_file = files_path + 'intrinsics.txt'
        extrinsics_file = files_path + 'pose_colmap/DSC00350.JPG.txt'
        ...
        vis_image = visualize_depth(depths, points_image, predicted_xyz, pred_img_idx)
